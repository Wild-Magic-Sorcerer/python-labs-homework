...
Реализуйте декоратор, который до вызова исходной функции выводит сообщение "Выполняется функция...", а после вызова исходной функции выводит "Функция выполнена.". Примените этот декоратор к функции, которая возвращает что либо (например квадрат числа, корень числа и т.д.), и продемонстрируйте результат работы.
